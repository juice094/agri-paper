...
This benchmark is generated by applying 7 fixed templates to each of the 15
seed records. The resulting 105 questions are therefore surface paraphrases
...
def extract_keywords(treatment: str, max_keywords: int = 2):
    ...
    Falls back to sentence splitting if semicolons are absent.
    """
    if ";" in treatment:
